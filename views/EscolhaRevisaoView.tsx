...
export default function EscolhaRevisaoView() {
  ...
  return (
    <div className="mx-auto max-w-7xl p-4 pb-24 md:p-6 space-y-5 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(320px,420px)_1fr]">
        ...
        <section className="space-y-5">
          ...
          {selected && (
            <form onSubmit={handleSaveReview} className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
